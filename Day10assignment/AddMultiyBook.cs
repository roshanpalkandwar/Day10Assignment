...
namespace Day10assignment
{
    internal class AddMultiyBook
    {
        ...
        public static List<AddMultiyBook> ContactDetail = new List<AddMultiyBook>();
        public Dictionary<string, AddMultiyBook> AddBook;
        public static void AddBook6()
        {
            AddMultiyBook person = new AddMultiyBook();
