...
namespace Day10assignment
{
    internal class AddMultPerson
    {
        ...
        public static List<AddMultPerson> ContactDetail = new List<AddMultPerson>();
        public static void AddBook5()
        {

            AddMultPerson person = new AddMultPerson();
